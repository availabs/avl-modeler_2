  ...
  return {
    ...
    sidenav: ({ color = "white", size = "compact" }) => {
      ...
      let sizes = {
        ...
        compact: {
          fixed: "pl-44",
          wrapper: "w-44 flex-col",
          sideItem: "flex text-base hover:pl-2",
          topItem: "flex items-center text-sm px-4 border-r h-12",
          icon: "mr-3 text-lg",
        },
        full: {
          ...
          wrapper: "w-64",
          sideItem:
            "flex mx-4 pr-4 py-4 text-base font-base border-b hover:pl-4",
      ...
      return {
        ...
        navitemTopActive: `
          group font-sans
            ...
            transition cursor-pointer
          `,
        mobileButton: `md:hidden ${colors[color].contentBg} inline-flex items-center justify-center p-2  text-gray-400 hover:bg-gray-100 `,
        vars: {
          colors,
          sizes,
        },
    ...
    navMenuBg:
      "bg-darkblue-500 bb-rounded-10 shadow-lg text-white rounded-b-lg",
    navMenuItem:
    ...
    inputBorderDisabled:
      "rounded border-2 border-gray-200 hover:border-gray-200",
    ...
    tableRow:
      "bg-gray-100 hover:bg-gray-200 transition ease-in-out duration-150",
    tableRowStriped:
