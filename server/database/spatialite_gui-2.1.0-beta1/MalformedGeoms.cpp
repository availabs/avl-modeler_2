...
//
  ...
  *count = 0;
  ...
  xname = (char *) malloc((geometry.Len() * 4) + 1);
  ...
  ret = sqlite3_get_table(GetSqlite(), xname, &results,
                          &rows, &columns, &errMsg);
  free(xname);
  if (ret != SQLITE_OK)
    {
...
//
  ...
  *count = 0;
  ...
  xname = (char *) malloc((sql.Len() * 4) + 1);
  strcpy(xname, sql.ToUTF8());
  ret = sqlite3_exec(GetSqlite(), xname, NULL, 0, &errMsg);
  free(xname);
  if (ret != SQLITE_OK)
    {
      wxMessageBox(wxT("SQLite SQL error: ") + wxString::FromUTF8(errMsg),
...
// a GRID to show results
  ...
  GridCtrl->SetCellAlignment(0, 2, wxALIGN_RIGHT, wxALIGN_TOP);
  ...
  GridCtrl->SetCellAlignment(1, 2, wxALIGN_RIGHT, wxALIGN_TOP);
  ...
  GridCtrl->SetCellAlignment(2, 1, wxALIGN_RIGHT, wxALIGN_TOP);
  sprintf(dummy, "%d", iHiwtr);
  cell = wxString::FromUTF8(dummy);
  GridCtrl->SetCellValue(2, 2, cell);
  GridCtrl->SetCellAlignment(2, 2, wxALIGN_RIGHT, wxALIGN_TOP);
  ...
  GridCtrl->SetCellAlignment(3, 1, wxALIGN_RIGHT, wxALIGN_TOP);
  sprintf(dummy, "%d", iHiwtr);
  cell = wxString::FromUTF8(dummy);
  GridCtrl->SetCellValue(3, 2, cell);
  GridCtrl->SetCellAlignment(3, 2, wxALIGN_RIGHT, wxALIGN_TOP);
  ...
  GridCtrl->SetCellAlignment(4, 1, wxALIGN_RIGHT, wxALIGN_TOP);
  sprintf(dummy, "%d bytes", iHiwtr);
  cell = wxString::FromUTF8(dummy);
  GridCtrl->SetCellValue(4, 2, cell);
  GridCtrl->SetCellAlignment(4, 2, wxALIGN_RIGHT, wxALIGN_TOP);
  ...
  GridCtrl->SetCellAlignment(5, 2, wxALIGN_RIGHT, wxALIGN_TOP);
  ...
  GridCtrl->SetCellAlignment(6, 1, wxALIGN_RIGHT, wxALIGN_TOP);
  sprintf(dummy, "%d bytes", iHiwtr);
  cell = wxString::FromUTF8(dummy);
  GridCtrl->SetCellValue(6, 2, cell);
  GridCtrl->SetCellAlignment(6, 2, wxALIGN_RIGHT, wxALIGN_TOP);
  ...
  GridCtrl->SetCellAlignment(7, 1, wxALIGN_RIGHT, wxALIGN_TOP);
  sprintf(dummy, "%d bytes", iHiwtr);
  cell = wxString::FromUTF8(dummy);
  GridCtrl->SetCellValue(7, 2, cell);
  GridCtrl->SetCellAlignment(7, 2, wxALIGN_RIGHT, wxALIGN_TOP);
  ...
  GridCtrl->SetCellAlignment(8, 2, wxALIGN_RIGHT, wxALIGN_TOP);
  ...
  GridCtrl->SetCellAlignment(9, 1, wxALIGN_RIGHT, wxALIGN_TOP);
  sprintf(dummy, "%d", iHiwtr);
  cell = wxString::FromUTF8(dummy);
  GridCtrl->SetCellValue(9, 2, cell);
  GridCtrl->SetCellAlignment(9, 2, wxALIGN_RIGHT, wxALIGN_TOP);
  ...
  GridCtrl->SetCellAlignment(10, 1, wxALIGN_RIGHT, wxALIGN_TOP);
  sprintf(dummy, "%d", iHiwtr);
  cell = wxString::FromUTF8(dummy);
  GridCtrl->SetCellValue(10, 2, cell);
  GridCtrl->SetCellAlignment(10, 2, wxALIGN_RIGHT, wxALIGN_TOP);
#else
  ...
  GridCtrl->SetCellAlignment(11, 2, wxALIGN_RIGHT, wxALIGN_TOP);
#else
  ...
  GridCtrl->SetCellAlignment(12, 2, wxALIGN_RIGHT, wxALIGN_TOP);
#else
  ...
  GridCtrl->SetCellAlignment(13, 2, wxALIGN_RIGHT, wxALIGN_TOP);
#else
  ...
  GridCtrl->SetCellAlignment(14, 1, wxALIGN_RIGHT, wxALIGN_TOP);
  ...
  GridCtrl->SetCellAlignment(15, 1, wxALIGN_RIGHT, wxALIGN_TOP);
#else
  ...
  GridCtrl->SetCellAlignment(16, 1, wxALIGN_RIGHT, wxALIGN_TOP);
#else
  ...
  GridCtrl->SetCellAlignment(17, 1, wxALIGN_RIGHT, wxALIGN_TOP);
#else
  ...
  GridCtrl->SetCellAlignment(18, 1, wxALIGN_RIGHT, wxALIGN_TOP);
#else
  ...
  GridCtrl->SetCellAlignment(19, 1, wxALIGN_RIGHT, wxALIGN_TOP);
#else
